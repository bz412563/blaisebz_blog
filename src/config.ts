...
export const navBarConfig: NavBarConfig = {
  links: [
    ...
    {
      name: 'GitHub',
      url: 'https://github.com/bz412563',     // Internal links should not include the base path, as it is automatically added
...
export const profileConfig: ProfileConfig = {
  ...
  name: 'BlaiseBZ',
  bio: '平凡無奇的一生，卻想記錄一些東西。也許這些被記錄的事情回過頭來看是閃爍的星星。',
  links: [
    {
      name: 'Discord',
      ...
      url: 'https://discord.gg/DMSEYHTttE',
    },
    {
      name: 'Steam',
      icon: 'fa6-brands:steam',
      url: 'https://steamcommunity.com/id/BlaiseBE/',
    },
    {
      name: 'GitHub',
      icon: 'fa6-brands:github',
      url: 'https://github.com/bz412563',
    },
  ],
}
